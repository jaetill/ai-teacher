...
export const driveFolders = pgTable(
  "drive_folders",
  {
    ...
    ownerEmail: text("owner_email"), // Google account email of the teacher who owns these folders
  ...
  (table) => [
    unique("uq_drive_folders_key").on(table.folderKey, table.ownerEmail).nullsNotDistinct(),
